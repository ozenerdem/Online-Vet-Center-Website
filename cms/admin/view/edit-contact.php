    ...
    <div class="box-container container-50">
        ...
        <?php if ($row['contact_read'] == 1): ?>
            <div class="message success box-">
                ...
                <br>
                <?= timeConvert($row['contact_read_date']) ?> <strong><?= $row['user_nickname'] ?></strong> tarafından
                okundu.
            </div>
        <?php endif; ?>
        ...
        <div class="box" id="div-1">
            ...
            <div class="box-content">
                ...
                <form action="" id="email-form" onsubmit="return false;" class="form">
                    ...
                    <ul>
                        <li>
                            <input type="text" name="subject" value="<?=$row['contact_subject']?>" id="input" placeholder="Mesaj Konusu">
                        </li>
                        <li>
